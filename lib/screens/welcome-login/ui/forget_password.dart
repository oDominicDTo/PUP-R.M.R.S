...
class ForgetPasswordScreen extends StatelessWidget {
  ...
  void _navigateBackToLogin() {
    // Pop all routes until reaching the LoginPage
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        // For example, you can show an alert or dialog
        return false; // Return true to allow the back button press, false to prevent it
      },
      child: Scaffold(
      body: Container(
              ...
              child: SizedBox(
                ...
                child: Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Positioned(
                        top: contentHeight * 0.18, // Adjust vertical position of 'Forget Password!' and 'Enter your Email'
                        child: RichText(
                      ...
                      Positioned(
                        top: contentHeight * 0.3, // Adjust vertical position of white box
                        child: Container(
