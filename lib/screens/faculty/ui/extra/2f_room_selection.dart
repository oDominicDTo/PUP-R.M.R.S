...
class TwoFRoomSelect extends StatefulWidget {
  const TwoFRoomSelect({Key? key}) : super(key: key);

  @override
  State<TwoFRoomSelect> createState() => _TwoFRoomSelectState();
}

class _TwoFRoomSelectState extends State<TwoFRoomSelect> {
  @override
                      ...
                      child: Column(
                        children: [
                          RoomBox("Room 201", () {
                            ...
                            print("Room 201 tapped");
                          }),
                          RoomBox("Room 202", () {
                            // Handle onTap for Room 202
                            print("Room 202 tapped");
                          }),
                          RoomBox("Room 203", () {
                            // Handle onTap for Room 203
                            print("Room 203 tapped");
                          }),
                          RoomBox("Room 204", () {
                            // Handle onTap for Room 204
                            print("Room 204 tapped");
                          }),
                          RoomBox("Room 205", () {
                            // Handle onTap for Room 205
                            print("Room 205 tapped");
                          }),
                        ],
                      ),
                    ),
